...
pubLeftWheelVel  = rospy.Publisher('/two_wheel_robot/left_wheel_velocity_controller/command', Float64, queue_size=1)
pubRightWheelVel = rospy.Publisher('/two_wheel_robot/right_wheel_velocity_controller/command', Float64, queue_size=1)
...
def take_action(action):
    ...
    if action == 1:
        robot_state.current_vel = robot_state.current_vel + 0.01
    else:
        robot_state.current_vel = robot_state.current_vel - 0.01

    pubLeftWheelVel.publish(robot_state.current_vel)
    pubRightWheelVel.publish(robot_state.current_vel)
